...
//		GUILayout.Space(6);
	...
	private void ScaleParticleValues(ParticleSystem ps, GameObject parent)
	{
		...
		//Gravity
		var gravity = psSerial.FindProperty("InitialModule.gravityModifier.scalar");
		if(gravity == null)
			gravity = psSerial.FindProperty("InitialModule.gravityModifier");
		if(gravity != null)
			gravity.floatValue *= ScalingValue;
